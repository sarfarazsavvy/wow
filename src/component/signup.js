...
import { StyleSheet, Text, View, Image, Alert, KeyboardAvoidingView, Dimensions, TouchableOpacity, Picker, ActivityIndicator, AsyncStorage, BackHandler } from 'react-native';
...
export default class Signup extends React.Component {
  ...
  uploaddata = () => {
    ...
    if (this.state.uri == '') {
      ...
      data.append('phonenumber', myphone);
      ...
      fetch(url, {
        ...
        .then((responseJson) => {
          ...
          // if(responseJson.errors.email[0] == 'The email has already been taken.')
          // {
          //   alert('The email has already been taken.');
          //   return;
          // }
          // if(responseJson.errors.phonenumber[0] == 'The phonenumber must be a number.')
          // {
          //   alert('The Phone Number has already been taken.');
          //   return;
          // }
          if (responseJson.message == 'Account Successfully Created') {
            alert('Your account has been created successfully. Please Verify Your Phone Number');
            ...
            this.props.navigation.navigate('otp', {PHONE: '+92'+phone, PHONE1: phone})
          ...
          {
            Alert.alert('INVALID DATA','Please try another email and phone number')
          }
        ...
        <View style={styles.responsiveBox}>
          <KeyboardAvoidingView behavior="padding">
            <ScrollView>
              ...
              {/* <Image style={{ alignSelf: 'center', width: 120, height: 120, marginTop: wp('15%'), marginBottom: wp('5%') }} source={require('./../image/camera.png')} /> */}
              <View style={{ marginTop: wp('0%') }}></View>
              ...
              <View style={{ flex: 1, flexDirection: 'row' }}>
                <FontAwesome name="lock" size={20} style={{ color: '#BFBFBF', marginTop: 23, marginLeft: 20, marginRight: 5 }} />
                <TextInput
                  style={styles.input}
                  theme={{
                    colors: {
