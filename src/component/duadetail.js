...
export default class duadetail extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <View style={styles.container}>
                <ScrollView>
                    <View style={{ backgroundColor: '#D49C0F', height: '13.2%' }}>
                        <View style={{ marginTop: hp('6%'), marginHorizontal: wp('5%'), flex: 1, flexDirection: 'row' }}>
                            ...
                            <Text style={{ fontSize: 20, color: 'white', alignSelf: 'center', marginLeft: wp('16%'), marginTop: -10 }}>DUA DETAIL PAGE</Text>
                        </View>
                    </View>


                    <View style={{ padding: 15 }}>
                        <Text style={{ fontSize: 26, color: '#D49C0F' }}>Subject on the dua</Text>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', marginTop: wp('10%'), }}>
                                ...
                                <TouchableOpacity
                                    style={{ width: 130, height: 45, backgroundColor: '#D49C0F', padding: 10, borderRadius: 5 }}
                                    onPress={() => this.props.navigation.navigate('#')}>
                                    <Text style={styles.buttonText}>Ameen</Text>
                                </TouchableOpacity>

                                <TouchableOpacity
                                    style={{ width: 130, height: 45, flex: 1, flexDirection: 'row', padding: 10, borderRadius: 5, marginLeft: wp('20%'), marginBottom: wp('5%') }}
                                    onPress={() => this.props.navigation.navigate('#')}>
