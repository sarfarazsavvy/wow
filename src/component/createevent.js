        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ backgroundColor: '#D49C0F', height: '11%' }}>
                    ...
                    <Text style={{ fontSize: 20, color: 'white', alignSelf:'center',marginLeft:wp('22%'), marginTop:-10 }}>CREATE EVENT</Text> 
                    </View>
                </View>
                ...
                <Text style={{color:'black'}}>Upload Picture (optional)</Text>
                <View style={{flex:1, flexDirection:'row', marginTop:wp('3%')}}>

                    <TouchableOpacity>
                    <View style={{backgroundColor:'#D2D2D2', padding:10}}>
                    <Image style={{width:50, height:50}} source={require('./../image/photo-camera.png')} />
                    </View>
                    </TouchableOpacity>
